...
router
  .route('/import')
  .post(auth('importProducts'), validate(productValidation.importProducts), productController.importProducts);
 ...
 *     description: Both admin and user can retrieve all products.
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Both admin and user can get products.
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     parameters:
